            ...
            spacing: Theme.spacing.lg
                ...
                SettingsGroup {
                    ...
                    SettingItem {
                        ...
                        description: qsTr("Block all traffic if VPN disconnects unexpectedly")
                        control: CustomSwitch {
                            id: killSwitchSwitch
                            checked: settingsViewModel ? settingsViewModel.killSwitch : false
                            onClicked: {
                                if (settingsViewModel) settingsViewModel.killSwitch = checked
                            }
                        }
                    }
